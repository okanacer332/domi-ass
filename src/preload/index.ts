...
const api: DomizanApi = {
  ...
  getAgentStatus: () => ipcRenderer.invoke("app:getAgentStatus"),
  listAgentMessages: (channel) => ipcRenderer.invoke("app:listAgentMessages", channel),
  sendAgentMessage: (input) => ipcRenderer.invoke("app:sendAgentMessage", input),
  clearAgentMessages: (channel) => ipcRenderer.invoke("app:clearAgentMessages", channel),
